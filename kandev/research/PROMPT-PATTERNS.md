...
**Важная поправка ко всему нижеследующему.** Разобранный корпус написан под
прежние поколения моделей, и часть его сильнейших приёмов сейчас вредна:
пошаговые сценарии, списки запретов, нажим капсом и порог уверенности внутри
роли ревью. Что именно устарело и чем заменяется —
[MODERN-MODEL-PROMPTING.md](MODERN-MODEL-PROMPTING.md). Сравнение рекомендаций
пяти провайдеров и разбор, какие расхождения настоящие, —
