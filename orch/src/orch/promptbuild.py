...
def _finish(ctx: Context) -> str:
    ...
    if gate is True:
        ...
        lines.append(
            ...
            "Разделы твоей роли про ворота и отчёт владельцу в этом прогоне не "
            "действуют: «Что решить» писать некому — этот вопрос решаешь ты, а "
            "выбор объясняешь в «Допущениях»."
        )
    else:
